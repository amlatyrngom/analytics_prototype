...
struct VectorOps {
   ...
   */
  static void ConstantCompVector(const Vector *in, const Value &val, OpType op_type, Filter *filter);
   ...
   */
  static void BinaryCompVector(const Vector *in1, const Vector *in2, Filter *filter, OpType op_type);
