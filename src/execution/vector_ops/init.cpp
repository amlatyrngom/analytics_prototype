...
void TemplatedInitVector(const Filter* filter, const Value& val, Vector* vec) {
...
void VectorOps::InitVector(const Filter* filter, const Value &val, SqlType val_type, Vector *out) {
  switch (val_type) {
